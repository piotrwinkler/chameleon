\section[Podstawy teoretyczne (Piotr Winkler)]{Podstawy teoretyczne}
  ...
  \begin{figure}[h]
    ...
    \caption[Struktura głębokiej sieci neuronowej składającej się wyłącznie z warstw gęstych - źródło: \url{https://towardsdatascience.com/building-a-convolutional-neural-network-male-vs-female-50347e2fa88b}]{Struktura głębokiej sieci neuronowej składającej się wyłącznie z warstw gęstych}
    \label{fig:dnn}
  \end{figure}
