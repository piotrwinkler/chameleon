...
\subsubsection{Rezultaty} \label{Rezultaty}
 ...
 \end{figure}
  ...
  Analizując pokolorowane obrazy na Rysunku ... można zauwążyć, że o wiele lepszą
  ...
  Jak widać zastosowanie w rozwiązaniu sieci neuronowej, która specjalizuje się w
  operacjach nie do końca związanych z  problematyką, do której sieć ta zostanie zastosowana,
  może pozytywnie wpłynąć na skuteczność całego rozwiązania. Utwierdza to w przekonaniu, że
  przeniesienie uczenia jest podejściem o wielu zaletach, które znacznie zwiększa ilość
  możliwych zastosowań sieci neuronowych oraz poszerza
