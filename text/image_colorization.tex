\subsection{Automatyczne kolorowanie czarno-białych obrazów}
  ...
  obrazu poprzez wyciągnięcie najbardziej istotnych wartości aktywacji z
  określonych obszarów reprezentacji w celu zmniejszenia zredukowania rozmiaru
  sieci, a co za tym idzie, zmniejszenia ilości obliczeń koniecznych do wykonania
  przez sieć. Ponadto This has the effect of making the resulting down sampled feature maps more robust to changes in the position of the feature in the image, referred to by the technical phrase “local translation invariance.”
