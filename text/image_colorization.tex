...
\subsubsection{Przetwarzanie końcowe danych}
...
\subsubsection{Rezultaty} \label{Rezultaty}
 ...
 \begin{figure}[ht]
   \centering
   \subfloat[Obraz zewnątrzny]{\includegraphics[width = 4.5in]{best_results_plane}} \\
   \subfloat[Obraz zewnątrzny]{\includegraphics[width = 4.5in]{best_results_krajobraz}} \\
   \subfloat[Obraz z datasetu]{\includegraphics[width = 4.5in]{best_results_horse}} \\
   \caption[Rezultaty - źródło: Rysunek własny na podstawie kolejno:
