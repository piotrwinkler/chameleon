...
\subsubsection{Rezultaty} \label{Rezultaty}
 ...
 \end{figure}
  ...
  Testowana architekura, po odpowiednim douczeniu, została wykorzystana do 
...
Analizując pokolorowane obrazy na Rysunku ... można zauwążyć o wiele lepszą 
jakość kolorowania uzyskaną z użyciem modelu, do którego została zastosowana metoda 
przeniesienia uczenia. Kolory są bla bla bla ... . Świadczy to, że podejście zaproponowane 
przez autorów rozwiązania może być skutecznie zastosowane jako rozwiązanie omawianej problematyki, 
...
możliwych zastosowań sieci neuronowych. 
