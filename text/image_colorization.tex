...
\subsubsection{Rezultaty} \label{Rezultaty}
 ...
 \end{figure}
  ...
  Z związku z tym została podjęta próba zastosowanie przeniesienia uczenia w
  ...
  Sieć ta składa się z zestawu warstw konwolucyjnych i warstw nadpróbkujących
  (ang. upsampling). Mają one na celu przetworzyć wejściówy zbiór cech po
  etapie fuzji w składowe kolorów przewidzianych dla obrazu wejściowego.
  Każda warstwa nadpróbkująca zwiększają dwukrotnie szerokość i wysokość obrazu
  używając algorytmu najbliższego sąsiada.
