...
\addcontentsline{toc}{section}{WYKAZ WAŻNIEJSZYCH OZNACZEŃ I SKRÓTÓW} % Dodanie to TOC
  ...
  \begin{itemize}
    ...
    model generatywny
    \item[Dropout] (!!!! ang. spadkowicz - tłumaczył Piotr Winkler) - technika regularyzacji mająca na celu ograniczać przeuczanie
    się sieci neuronowych przez zapobieganie złożonej koadaptacji danych treningowych
