\subsection{TorchFrame}
  ...
  \subsubsection{PyTorch}
    ...
    \begin{quote}
      ...
      różnicują skalarną funckję celu.'
    \end{quote}
  ...
  \subsubsection{Architektura TorchFrame}
    ...
    całego systemu przedstawiony został na Rysunku \ref{fig:torchframetrain}.
      ...
      \begin{figure}[!h]
        \centering
        \includegraphics[width=6.5in]{torchframetrain}
    ...
    Centralnym punktem całej zaprezentowanej architekruty jest \textit{entrypoint}. Stanowi on
  ...
  \subsubsection{Konfiguracja w TorchFrame}
    ...
    \begin{longtable}{ |m{2cm}|m{11cm}| }
     ...
     \hline
       ...
       celu zostanie wyznaczona zgonie z podanym powyżej wzorem. Wartość \textit{mean}
     ...
     \hline
       ...
       \item \textit{reduction} - czytaj \textit{reduction} dla funckji \textit{L1Loss}.
       \end{itemize} \\
     ...
     Loss} &
       ...
       błędu bezwzględnego spada poniżej 1 oraz funckji \textit{L1} w przeciwnym
    ...
    \begin{figure}[h]
      ...
      \caption[Przykładowa płaszczyzna funckji celu - źródło: \url{https://towardsdatascience.com/neural-network-optimization-7ca72d4db3e0}]{Przykładowa płaszczyzna funckji celu}
      \label{fig:plaszczyzna_optymalizacji}
    \end{figure}

    Można powiedzieć, że argumentami funckji celu są wagi modelu sieci neuronowej.
    ...
    gradient funkcji kosztu zależnej od wag sieci $\Theta$.

    Gradient ten wyznaczany jest z wykorzystaniem bardzo popularnego obecnie
    ...
    \begin{quote}
      'Rozważmy sieć neuronową z pojedynczym wejściem rzeczywistym $x$ i funckją
    ...
    pędu. Ogranicza ona oscylacje spadku gradientu w niewłaściwych kierunkach i
    ...
    \begin{longtable}{ |m{3cm}|m{10cm}| }
     ...
     \hline
       ...
       Autorzy Adama zauważyli, że $m_t$ oraz $v_t$, które inicjalizowane są jako
    ...
    posortowane, aby uniknąć powtarzalnej kolejności ich przekazaywania na wejście
